 ...
 */
export type ContentCategory = 'dashboard' | 'active-source' | 'now-listening' | 'sources' | 'sinks' | 'routes' | 'favorites' | 'source' | 'sink' | 'route' | 'stats' | 'logs' | 'system-devices' | 'discovery';
