...
#include "thread_safe_queue.h" // Ensure this is included at the top level, after std libs
...
using NotificationQueue = ::screamrouter::utils::ThreadSafeQueue<NewSourceNotification>;
